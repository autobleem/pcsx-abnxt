/*
 * <dirent.h> for the Windows (MinGW) development build of pcsx-abnxt.
 *
 ...
 * filter (frontend/menu.c) use. Implemented over
...
struct dirent {
	long           d_ino;       /* the kind again, in libpicofe/posix.h's numbering - see readdir() */
